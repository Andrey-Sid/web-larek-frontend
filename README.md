...
Расширение класса Model, билдер класса OrderData. Заказ формируется в 3 этапа. 1 - добавление в корзину, 2 - указание способа покупки и адреса, 3 - указание email и телефона.
